...
function thenJoinVoiceChannel(conn) {
    console.log(`Scribe: ready: ${conn}!`);
    // create our voice receiver
    const receiver = conn.re;
...
client.on('voiceStateUpdate', (oldMember, newMember) => {
    console.log("Scribe: oldChannel:", oldMember.voiceChannel.name);
    console.log("Scribe: newChannel:", newMember.voiceChannel.name);
...
client.on('ready', () => {
    ...
    //let channelid = '664085438562304002'
    ...
    thenJoinVoiceChannel(client.voiceConnections.get('644587330673311784'));  
    // .then(conn => thenJoinVoiceChannel(conn))
        // .catch(console.log);
    console.log("Joined");
